                            ...
                            case "2":
                                ...
                                for (String[] userInformation : userInformationS) {
                                    if (userInformation[0].split(":")[1].equals(name)&&userInformation[1].split(":")[1].equals(password)){
                                        ...
                                        String[][] newU1 = Arrays.copyOf(userInformationS,logOutIndex);
                                        newU1 =Arrays.copyOf(newU1,userInformationS.length-1);
                                        for (int i = logOutIndex;i<userInformationS.length-1;++i){
                                            newU1[i] = userInformationS[i+1];
                                        }
                                        userInformationS = newU1;
                                        for (String[] u : userInformationS){
                                           u[2]= "编号:"+(Integer.parseInt(u[2].split(":")[1])-1);
                                        }
                                        break;
                                    }
                                }
                                    ...
                                    case "2":
                                        ...
                                        for (int i = 0; i < userInformationS.length; i++) {
                                            if (userInformationS[i][0].split(":")[1].equals(userToUserIndex)){
                                                ...
                                                if (money>0){
                                                    if(Integer.parseInt(userInformationS[loginIndex][4].split(":")[1])-money<0) System.out.println("转账金额过大!!");else {
